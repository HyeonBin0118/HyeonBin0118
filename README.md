...
- **[job-agent-v2](https://github.com/HyeonBin0118/job-agent-v2)** — v1 개선, 사이드바 UX + 자소서 길이/포맷 커스터마이징 + AI 상담 채팅
   `GPT-4o-mini` `Streamlit` · [🚀 Demo](https://job-agent-v2-24afclwhripefpk3gmqnr9.streamlit.app)
...
`Python` `PyTorch` `LangChain` `LangGraph` `ChromaDB` `OpenAI API` `Cohere` `FastAPI` `PostgreSQL` `Redis` `Docker` `Streamlit` `YOLOv5` `OpenCV`
