...
- **[shopping-rag-final](https://github.com/HyeonBin0118/shopping-rag-final)** — ShopAI 최종, 챗봇 + 이미지 검색 + RAGAs 성능 대시보드 통합
  ...
  - ↳ **[shopping-rag-v4](https://github.com/HyeonBin0118/shopping-rag-v4)** — v3 성능 정량 평가, RAGAs + 이미지 검색 Hit@K 평가 + 결과 시각화
    ...
    - ↳ **[shopping-rag-v3](https://github.com/HyeonBin0118/shopping-rag-v3)** — v2 개선, GPT-4o Vision 이미지 검색 + 카테고리 필터링 + 합성 데이터 생성
      ...
      - ↳ **[shopping-rag-v2](https://github.com/HyeonBin0118/shopping-rag-v2)** — v1 개선, 리뷰 한국어 번역 + Cohere Re-ranking + 배포
        `Cohere Rerank` `GPT-4o-mini` · [🚀 Demo](https://shopping-rag-v2-db2ox3udz3gbsunb7m8jbq.streamlit.app/)
        - ↳ **[shopping-faq-rag](https://github.com/HyeonBin0118/shopping-faq-rag)** — v1, FAQ + 상품 + 리뷰 기반 RAG 챗봇, Ollama vs OpenAI RAGAs 비교
...
- **[ai-career-assistant](https://github.com/HyeonBin0118/ai-career-assistant)** — 자소서 생성 → 면접 연습 → 음성 대화형 면접 → 평가 리포트 올인원 플랫폼
  `FastAPI` `PostgreSQL` `Redis` `Celery` `Docker` `Whisper` `Edge-TTS` `GPT-4o-mini` · Redis 캐싱 25% · 비동기 처리 93% 단축
  - ↳ **[mock-interview-ai](https://github.com/HyeonBin0118/mock-interview-ai)** — 음성 답변 기반 AI 모의 면접 파이프라인 (출발점)
    `FastAPI` `PostgreSQL` `Redis` `Docker` `Whisper` `GPT-4o-mini` · [🎬 영상](https://youtu.be/cCh4mFKcWrI)
  - ↳ **[job-agent-v3](https://github.com/HyeonBin0118/job-agent-v3)** — 채용공고 분석 + 자소서 생성 + 가설 검증 (출발점)
...
- **[ai-coding-test-assistant](https://github.com/HyeonBin0118/ai-coding-test-assistant)** — 코딩 테스트 문제 자동 인식 + 힌트/접근법/정답 제공 데스크톱 어시스턴트
