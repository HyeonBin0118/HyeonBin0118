...
- **[ai-career-assistant](https://github.com/HyeonBin0118/ai-career-assistant)** — 통합 플랫폼
  `FastAPI` `PostgreSQL` `Redis` `Celery` `Docker` `Whisper` `Edge-TTS` `GPT-4o-mini`
  · Redis 캐싱 25% · 비동기 처리 93% 단축
...
- **[ai-coding-test-assistant](https://github.com/HyeonBin0118/ai-coding-test-assistant)**
