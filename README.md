...
코딩 테스트 풀이 중 위젯 형태로 화면에 플로팅 되어있다가 문제를 자동 인식하고 힌트·접근법·정답을 제공하는 데스크톱 어시스턴트

- **[ai-coding-test-assistant](https://github.com/HyeonBin0118/ai-coding-test-assistant)** — 메인 프로젝트
  `FastAPI` `PyQt6` `Playwright` `OpenAI` `pywinauto` `SSE` · [🎬 영상](https://youtu.be/qTPpKzS6hcg)
  - ↳ **[coder-llm-finetune](https://github.com/HyeonBin0118/coder-llm-finetune)** — GPT-4o-mini를 7B 모델로 대체하기 위한 QLoRA 파인튜닝 실험
    `Qwen2.5-Coder-7B` `QLoRA` `PEFT` `bitsandbytes` · val loss -63% · 파라미터 정확도 100%
...
<table>
  ...
  <tr>
    <td><b>AI/ML</b></td>
    <td>PyTorch · LangChain · LangGraph · ChromaDB · OpenAI API · Cohere · Whisper</td>
  </tr>
  <tr>
    <td><b>Backend</b></td>
