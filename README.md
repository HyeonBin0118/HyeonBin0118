...
RAG 성능 평가, 캐싱 효과 측정, QLoRA 파인튜닝 실험 등 수치로 결과를 기록합니다.
...
- **[ai-coding-test-assistant](https://github.com/HyeonBin0118/ai-coding-test-assistant)** — 메인 어시스턴트
  ...
  - ↳ **[coder-llm-finetune](https://github.com/HyeonBin0118/coder-llm-finetune)** — GPT-4o-mini를 7B 오픈소스 모델로 대체하기 위한 QLoRA 파인튜닝 실험
    `Qwen2.5-Coder-7B` `QLoRA` `PEFT` `bitsandbytes` `Transformers`
    · v1→v4 반복 실험으로 val loss 63% 감소 (0.552→0.203) · 파라미터 정확도 100% 달성
    · 데이터 품질/프롬프트 설계 변경이 학습 효율에 미치는 영향을 정량적으로 측정
...
<table>
  ...
  <tr>
    <td><b>AI/ML</b></td>
    <td>PyTorch · Transformers · PEFT · QLoRA · bitsandbytes · LangChain · LangGraph · ChromaDB · OpenAI API · Cohere · Whisper</td>
  </tr>
  <tr>
    <td><b>Backend</b></td>
