...
- **[shopping-rag-final](https://github.com/HyeonBin0118/shopping-rag-final)** — ShopAI 최종 완성판, 챗봇 + 이미지 검색 + RAGAs 성능 대시보드 통합  
  `GPT-4o Vision` `Cohere Rerank` `RAGAs` · [🚀 Demo](https://shopping-rag-final-2uvz8tccm5pucljl8spjrc.streamlit.app)
...
## 🛠️ Tech Stack
`Python` `PyTorch` `LangChain` `ChromaDB` `OpenAI API` `Cohere` `Streamlit` `YOLOv5` `OpenCV`
